...
export default function HeroSection() {
	return (
		<section id="home" className="px-4 pb-16 pt-8 sm:px-6 lg:px-8 lg:pt-10">
			<div className="mx-auto grid max-w-7xl items-start gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-8">
				<div className="pt-8 lg:pt-16">
					...
					<div className="mt-8 flex flex-col items-start gap-4 sm:flex-row">
						<a
							className="inline-flex min-w-[11.5rem] items-center justify-center rounded-xl bg-[#0088FF] px-8 py-3.5 text-base font-semibold text-white transition hover:bg-[#0075DB]"
							href="#services"
						>
							View Services
						</a>
						<a
							className="inline-flex min-w-[17rem] items-center justify-center rounded-xl border-2 border-[#0BE7FF] px-8 py-3.5 text-base font-semibold text-[#00CCE5] transition hover:bg-[#0BE7FF]/10"
							href="#contact"
						>
							Book an Appointment
						</a>
				...
				<div className="relative mx-auto w-full max-w-[35rem] lg:mt-2">
					...
					<div className="absolute -bottom-5 -left-20 hidden w-[18rem] overflow-hidden rounded-[2rem] border-8 border-[#ECF5FF] bg-white shadow-sm xl:block">
