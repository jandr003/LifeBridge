			...
			<div className="mx-auto max-w-6xl">
				<div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-8">
					...
					<div className="pt-8 lg:pt-12">
						...
						<p className="relative z-30 mt-6 max-w-[38rem] text-base font-medium leading-7 text-[#7783A1] sm:text-[1.05rem] sm:leading-8">
						...
						<div className="mt-8 flex flex-col items-start gap-4 sm:flex-row">
							<a href="#services" className="inline-flex min-w-[11rem] items-center justify-center rounded-xl bg-[#0088FF] px-8 py-3.5 text-base font-semibold text-white transition hover:bg-[#0075DB]">
								View Services
							</a>

							<a href="#contact" className="inline-flex min-w-[15rem] items-center justify-center rounded-xl border-2 border-[#0BE7FF] px-8 py-3.5 text-base font-semibold text-[#00CCE5] transition hover:bg-[#0BE7FF]/10">
								Book an Appointment
							</a>
						</div>

						<div className="relative z-10 mt-10 w-full max-w-[20rem] lg:-mb-16">
					...
					<div className="relative w-full mt-8 lg:mt-28 lg:-translate-x-16">
